      ...
      <div className="WIE_MAIN">
          ...
          <div className="wie_content">
            <div>
              <div className="wie_desc">
                ...
                advancements related to technology and social issues to women to
                make them whole as an individual with a firm technical
        ...
        <div className="about_footer m-4">
          ...
          <div className="footer_desc">
            ...
            to become acquainted with the industry which is not provided by the
            university syllabus.
          </div>
        </div>
      </div>
